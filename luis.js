...
const setPostElement = (post, userId, postId)=>{
    ...
    if(userId.toString() === localStorage.getItem('userId')){
        ...
        deleteButton.addEventListener('click', async ()=>{
            ...
            // postId is the parameter when function is called
        ...
        editButton.addEventListener('click', async ()=>{
            ...
            if(editMode === false){
                ...
                editForm.addEventListener('submit', async (event)=>{
                    ...
                    // first object is body, second is headers
...
// Gets every link in navigation bar
...
signUpForm.addEventListener("submit", async(event)=>{
    ...
    try{
        ...
        // creates a dom table for the user
...
if (localStorage.getItem('userId')){
    ...
    heading.innerText = `Welcome back ${localStorage.getItem('userName')}`
